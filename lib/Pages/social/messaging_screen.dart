...
class _MessagingScreenState extends State<MessagingScreen> {
  ...
  final List<_Conversation> _convos = [
    _Conversation(
      ...
      name: 'Dr. Amina',
      avatar: 'DA',
      lastMessage: 'Thanks for the feedback on the reel!',
      time: '2m',
      unread: 2,
      online: true,
    ),
    _Conversation(
      ...
      name: 'DesignWithSam',
      avatar: 'DS',
      lastMessage: 'Can you share the Figma file?',
      time: '14m',
      unread: 0,
      online: true,
    ),
    ...
    _Conversation(
      ...
      name: 'Finance Lab',
      avatar: 'FL',
      lastMessage: 'New video dropping Friday!',
      time: '3h',
      unread: 1,
      online: false,
    ),
    ...
    _Conversation(
      ...
      name: 'Mona H.',
      avatar: 'MH',
      lastMessage: 'Booked your workshop!',
      time: '2d',
      unread: 0,
      online: true,
    ),
                      ...
                      : ListView.separated(
                          ...
                          itemBuilder: (_, i) => _ConvoTile(
                            ...
                            onTap: () => Navigator.of(context).push(
                              MaterialPageRoute(
                                builder: (_) => ChatScreen(convo: convos[i]),
                              ),
                            ),
                          ),
                        ),
...
class _ChatScreenState extends State<ChatScreen> {
  ...
  void initState() {
    ...
    _messages = [
      ...
      _Message(
        text: 'Thanks so much! Glad it was helpful.',
        isMine: true,
        time: '10:22 AM',
      ),
      _Message(
        text: 'Would you ever do a longer workshop on this topic?',
        isMine: false,
        time: '10:24 AM',
      ),
      _Message(
        text: 'Definitely! I\'m planning one for next month.',
        isMine: true,
        time: '10:25 AM',
      ),
                ...
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      Text(
                        widget.convo.online ? 'Online' : 'Offline',
                        style: TextStyle(
