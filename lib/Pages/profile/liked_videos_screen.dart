...
class LikedVideosScreen extends StatelessWidget {
  ...
  static const List<_LikedVideo> _videos = [
    _LikedVideo(
      title: '3 prompts to learn any topic faster',
      creator: 'Dr. Amina',
      category: 'AI',
      gradient: [Color(0xFF7C2D12), Color(0xFF1A0A00)],
    ),
    _LikedVideo(
      title: 'How to critique UI like a senior designer',
      creator: 'DesignWithSam',
      category: 'Design',
      gradient: [Color(0xFF78350F), Color(0xFF1A0A00)],
    ),
    _LikedVideo(
      title: 'Budget framework for creators in 60s',
      creator: 'Finance Lab',
      category: 'Finance',
      gradient: [Color(0xFF134E4A), Color(0xFF001A18)],
    ),
    _LikedVideo(
      title: 'Python data structures explained',
      creator: 'CodeWithAhmed',
      category: 'Tech',
      gradient: [Color(0xFF1E3A5F), Color(0xFF001020)],
    ),
    _LikedVideo(
    ...
    _LikedVideo(
      title: 'Design systems in 5 minutes',
      creator: 'DesignWithSam',
      category: 'Design',
      gradient: [Color(0xFF78350F), Color(0xFF1A0A00)],
    ),
    ...
    _LikedVideo(
      ...
      creator: 'DesignWithSam',
      category: 'Design',
      gradient: [Color(0xFF4C1D95), Color(0xFF0A0020)],
    ),
  ];
